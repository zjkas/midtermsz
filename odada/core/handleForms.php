...
// 	$query = insertCustomer($pdo, $_POST['table_num'], $_POST['cus_name'], $_POST['added_by'], $_POST['date_added'], $_SESSION['username']);
...
// 	$query = updateCustomer($pdo, $_POST['table_num'], $_POST['cus_name'],$_GET['customer_id']);
...
// 	$query = insertOrder($pdo, $_POST['order_name'], $_POST['quantity'], $_SESSION['username'], $_GET['customer_id']);
...
if (isset($_POST['editOrderBtn'])) {
	...
	if ($query) {
		header("Location: ../index.php?customer_id=" .$_GET['customer_id']);
	}
	else {
		echo "Update failed";
	}
